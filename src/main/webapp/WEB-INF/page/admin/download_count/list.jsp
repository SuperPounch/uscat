			...
			<div class="block">
				...
				<div class="main">
					...
					<table id="table" class="table">
						...
						<tbody>
							<c:forEach items="${pageInfo.list}" var="downloadCount">
								<tr>
									<td class="checkbox"><input type="checkbox" class="fill listen-1-2" value="${downloadCount.id}" name="id" /> </td>
									<td><input type="text" class="text" name="sort" value="${downloadCount.sort}" data-type="非负整数" error-msg="请填写非负整数" error-pos="36" /></td>
									<td><input type="text" class="text" name="name" value="${downloadCount.name}" data-type="必填" error-pos="36" /></td>
									<td>api/download.json?apiId=${downloadCount.id}</td>
									<td>
										<a href="edit.action?id=${downloadCount.id}">
