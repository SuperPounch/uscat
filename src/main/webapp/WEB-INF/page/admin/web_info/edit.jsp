			...
			<div class="block">
				...
				<div class="main">
					...
					<form id="form">
						...
						<!--显示授权-->
						<div class="unit">
							<div class="left"><p class="subtitle">显示授权</p></div>
							<div class="right">
								<ul class="equal-8">
									<c:choose>
										<c:when test="${webInfo.license=='0'}">
											<li><input type="radio" class="fill" name="license" value="1" />是</li>
											<li><input type="radio" class="fill" name="license" value="0" checked/>否</li>
										</c:when>
										<c:otherwise>
											<li><input type="radio" class="fill" name="license" value="1" checked/>是</li>
											<li><input type="radio" class="fill" name="license" value="0" />否</li>
										</c:otherwise>
									</c:choose>
									<span class="clearfix"></span>
								</ul>
